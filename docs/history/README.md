...
| [admin.md](admin.md) | `/api` becoming `/admin`, and the indistinguishability it gave up for uniformity; a browser let in by passkey; the pre-launch gate that stood in front of it going |

 ...
 * `SearchableCollection('float')` is the language's. {@link \NeuroSYS\Test\Unit\GuidelineTest}
 ...
 * {@link \NeuroSYS\Model\Link\HiDriveLink} checks a share id at its own constructor: the test

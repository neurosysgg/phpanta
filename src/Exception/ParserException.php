...
/**
 * The ParserException class. Thrown when hand-authored markup is not something this site's own
 * vocabulary can hold.
 *
 * Six throws in {@link \Phpanta\View\Html\MarkupParser}, between them refusing an element this site

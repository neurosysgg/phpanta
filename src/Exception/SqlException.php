 ...
 * is not there: those are SQLite's answers and arrive as PHP's own `PDOException`, which keeps the
 * SQLSTATE a caller may want to tell a duplicate from anything else.
 */

 ...
 * offer a choice. Every other link opens where it is, which is the absence of this
 ...
 * the one place a site writes an outbound link, and neither is much use without the other.
 */
enum LinkTarget: string
{
    /** A new tab or window, for an outbound link that should not replace the page. */
    case Blank = '_blank';
}

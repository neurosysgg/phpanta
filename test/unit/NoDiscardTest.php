    ...
    public function testExactlyTheseResultsMayNotBeDiscarded(): void
    {
        self::assertSame(
            [
                ...
                'Phpanta\Form\Submission::refusal',
                ...
                'Phpanta\Http\Api\ApiResult::text',
                ...
                'Phpanta\Http\Session::admin',
                'Phpanta\Http\Session::adminSince',
                'Phpanta\Http\Session::attachTo',
                'Phpanta\Http\Session::challenge',
                ...
                'Phpanta\Http\Session::withAdmin',
                'Phpanta\Http\Session::withChallenge',
                'Phpanta\Http\Session::withMessage',
                'Phpanta\Http\Session::withToken',
                'Phpanta\Http\Session::withUser',
                'Phpanta\Http\Session::without',
                'Phpanta\Http\Session::withoutAdmin',
                'Phpanta\Http\Session::withoutChallenge',
                ...
                'Phpanta\Model\Health\HealthResult::sections',
                ...
                'Phpanta\Model\Update\ProbeReport::section',
                ...
                'Phpanta\Model\Update\UpdateReport::section',
                ...
                'Phpanta\Service\Passkey\PasskeyVerifier::registers',
                ...
                'Phpanta\Support\FileLock::beside',
